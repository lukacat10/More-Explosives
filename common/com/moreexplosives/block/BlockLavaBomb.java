...
public class BlockLavaBomb
extends aqw {
    public mr tex1;
    public mr tex2;
    public mr tex3;

    public BlockLavaBomb(int i, int j) {
        super(i, ajz.u);
        this.a(BlockLavaBomb.j);
        this.a(wv.g);
        this.a(wv.m);
        this.a(wv.d);
    }
    ...
    public void a(abv world, int i, int j, int k, abq e) {
        EntityLavaExplosivePrimed entitylavabombprimed = new EntityLavaExplosivePrimed(world, (double)((float)i + 0.5f), (double)((float)j + 0.5f), (double)((float)k + 0.5f));
        entitylavabombprimed.fuse = world.s.nextInt(entitylavabombprimed.fuse / 4) + entitylavabombprimed.fuse / 8;
        world.d((nm)entitylavabombprimed);
    }
    ...
    public void g(abv world, int i, int j, int k, int l) {
        if ((l & 1) == 1 && !world.I) {
            EntityLavaExplosivePrimed entitylavabombprimed = new EntityLavaExplosivePrimed(world, (double)((float)i + 0.5f), (double)((float)j + 0.5f), (double)((float)k + 0.5f));
            world.d((nm)entitylavabombprimed);
            world.a((nm)entitylavabombprimed, "random.fuse", 1.0f, 1.0f);
        }
    }
